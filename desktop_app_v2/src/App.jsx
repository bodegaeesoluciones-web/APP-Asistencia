...
function App() {
  // Siempre iniciar sin autenticación — por seguridad, siempre se debe loguear al abrir
  ...
  // Auto-login DESHABILITADO por seguridad: la app de escritorio siempre requiere login manual.
